...
private:
    ...
    void hide_color() { color_menu.hide(); menu_button.show(); }
    ...
    void solid_pressed() { change_style(Line_style::dot); hide_style(); }
    void dash_pressed() { change_style(Line_style::dash); hide_style(); }
    void dot_pressed() { change_style(Line_style::solid); hide_style(); }
   
    void color_pressed() { menu_button.hide(); color_menu.show(); }
...
Lines_window::Lines_window(Point xy, int w, int h, const string& title): Window{xy, w, h, title},
    ...
    style_menu{Point{50,50},80, 20, Menu::vertical, "style"},
    style_button{Point{50,50},80,20, "style menu",
        [](Address, Address pw) {
